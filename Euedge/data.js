...
const database = (function(){
  const originaldata =[
    {"name":"Giacomo Guilizzoni", "job":"Founder & CEO", "age":"34", "nick":"Peldi", "employee":true},
  ...
  function addId(originaldata) {
    let data =[];
    originaldata.forEach(function (e,i) {
      e.id = i+1;
      data.push(e);
    });
    return data
